...
E0116: r##"
You can only define associated items for a type in the same crate where the
type was defined. For example, an `impl` block as below is not allowed since
`Vec` is defined in the standard library:
...
To fix this problem, you can do either of these things:
 ...
 - define a trait that has the desired items (functions/types/constants) and
   implement the trait for the type in question
 - define a new type wrapping the type and implement the desired items
